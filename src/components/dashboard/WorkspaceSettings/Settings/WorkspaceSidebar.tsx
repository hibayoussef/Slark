...
export default function ClippedDrawer() {
    ...
    const onSettings = () =>{
        ...
        navigation('/settings/workspaceSettings');
    }
                    ...
                    <div className={classes.drawerContainer}>
                        ...
                        <List>
                            ...
                            <Typography className={classes.padding}>
                                HIBA YOUSSEF'S WORKSPACE
                            </Typography>

                            <ListItem button onClick={onSettings} className={classes.padding } >

                                <ListItemText  ><h1>Settings</h1></ListItemText>
                            </ListItem >
                            ...
                            <ListItem button className={classes.padding}>
                                ...
                                <ListItemText>Security & Permissions</ListItemText>
                            </ListItem>
